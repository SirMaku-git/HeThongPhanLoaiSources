...
- **Ngôn ngữ**: C++ (100%)
- **Mục đích sử dụng**: Dự án môn Tự động hóa - Trường Đại học [*TODO: Tên trường*]
...
> **Lưu ý:** Các tính năng được đánh dấu `[DEBUG]` trong quá trình phát triển sẽ không được thêm vào phiên bản chính thức nộp cho trường.
